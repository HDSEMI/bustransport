...
class WECMF_General_Template{
	...
	public function wecmf_get_reset_password_url(){
		...
		$reset_pass .= '<a class="link thwecmf-link" href="<?php echo esc_url( add_query_arg( array( \'key\' => $reset_key, \'id\' => $user_id ), wc_get_endpoint_url( \'lost-password\', \'\', wc_get_page_permalink( \'myaccount\' ) ) ) ); ?>">
